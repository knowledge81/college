...
<div class="super_container">
	...
	<div class="container" style="color:black">
		<form action="registered.php" method="POST" enctype="multipart/form-data">
				...
				<tr>
					...
					<td>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="phone" name="phone" maxlength="10" value="<?
				...
				<tr>
					...
					<td>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="postalcode" name="postalcode" maxlength="9" value="<?
			...
			<br>
			<button type="submit" class="btn btn-primary" name="preregister">Register</button>
		</form>
	</div><br>
	<!-- Popular -->
